    ...
    <PageLayout title="About">
      ...
      <section className="prose lg:prose-xl dark:prose-light mt-10 mb-20">
        ...
        <p>
          ...
          organize various workshops, events and projects to help peers.
        </p>
        <p>
          Not too long ago, I worked at a startup called{" "}
          <SmartLink href="https://www.lisnclips.app/">LISN</SmartLink>. Now, I
          am working on a few side projects. I am working on a knowledge-sharing
          platform for students in SCESoc called,{" "}
          <SmartLink href="https://github.com/SCESoc/torch">Torch</SmartLink>.
          Torch is a web application that surfaces open-source knowledge created
          by students in SCESoc in our{" "}
        ...
        <p>
          On this site, I share things I am working on as well as my thoughts on
