    ...
    <div>
      <div className='w-full flex justify-center py-10'>
        <div id='socials' className='w-full max-w-7xl flex justify-center'>
          <FooterIcon link='https://www.lisnclips.app/' icon={LISNImage} label='Link to LISN' />
          <FooterIcon link='https://www.scesoc.ca/' icon={SCESocImage} label='Link to SCESoc' />
          <FooterIcon link='https://github.com/dharshatharan' icon={GithubImage} label='Link to my GitHub' />
          <FooterIcon link='https://www.linkedin.com/in/dharshatharan/' icon={LinkedinImage} label='Link to my LinkedIn' />
          <FooterIcon link='https://www.instagram.com/dharshatharan/' icon={InstagramImage} label='Link to my Instagram' />
          <FooterIcon link='https://twitter.com/dharshatharan' icon={TwitterImage} label='Link to my Twitter' />
        </div>
      </div>
      <div className='bg-dark-grey w-full flex justify-between p-5 text-off-white font-normal text-xs md:text-base'>
        <span>Built with <a className="underline" target='_blank' href='https://nextjs.org/' rel="noreferrer">Next.js</a></span>
...
const FooterIcon = ({ link, icon, label }: footerIconProps) => (
  <a href={link} target='_blank' className='h-12 w-12 md:h-14 md:w-14 relative mx-2 md:mx-7' rel="noreferrer">
