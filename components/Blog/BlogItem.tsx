    ...
    <Link href={`/posts/${props.id}`}>
      <div className='group h-80 w-80 md:h-96 md:w-96 relative rounded-xl md:rounded-2xl'>
        ...
        <div className='relative z-10 h-full bg-black bg-opacity-40 rounded-xl md:rounded-2xl p-5 flex flex-col justify-between group-hover:bg-transparent transition duration-500 ease-in-out transform'>
          <h2 className='text-3xl text-off-white font-semibold group-hover:text-dark-grey dark:group-hover:text-off-white transition duration-500 ease-in-out transform'>{props.title}</h2>
          <div className='text-off-white text-lg group-hover:text-dark-grey dark:group-hover:text-off-white transition duration-500 ease-in-out transform'>
