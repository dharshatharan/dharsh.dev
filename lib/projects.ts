...
export const featuredProjects: Project[] = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1355&q=80",
    url: "https://github.com/dharshatharan/web-book",
  },
  {
    name: "Makers Club",
    description:
